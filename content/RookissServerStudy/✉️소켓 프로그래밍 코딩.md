...
//AddressList가 배열인 이유
//ip를 여러개 관리 할 수 도있다 트래픽이 어마어마하게 많은경우
//어떤사람한테는 1번주소 다른사람한테는 2번주소로 알려주면서 부하분산을 하는경우도있다

//DNS로 어떻게 IP를 찾았는지에 대한건 따로 공부해보자
//간단하게 말하자면 DNS서버가 우리 네트워크 망 안에 하나가 더 있다고한다
IPAddress ipAddr = ipHost.AddressList[0];

//최종 ip주소
//ipAddr = 식당주소, 7777 = 식당 정문 후문 문의번호
